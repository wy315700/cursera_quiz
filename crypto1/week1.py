...
ciphertext1 = ciphertext1.decode('hex')[0:83]
ciphertext2 = ciphertext2.decode('hex')[0:83]
ciphertext3 = ciphertext3.decode('hex')[0:83]
ciphertext4 = ciphertext4.decode('hex')[0:83]
ciphertext5 = ciphertext5.decode('hex')[0:83]
ciphertext6 = ciphertext6.decode('hex')[0:83]
ciphertext7 = ciphertext7.decode('hex')[0:83]
ciphertext8 = ciphertext8.decode('hex')[0:83]
ciphertext9 = ciphertext9.decode('hex')[0:83]
ciphertext10 = ciphertext10.decode('hex')[0:83]
ciphertext11 = ciphertext11.decode('hex')[0:83]
# print ciphertext1
# print ciphertext2
# print ciphertext3
# print ciphertext4
...
# print strxor(strxor(strxor(strxor(strxor(strxor(strxor(strxor(strxor(strxor(ciphertext1, ciphertext2), ciphertext3), ciphertext4), ciphertext5), ciphertext6), ciphertext7), ciphertext8), ciphertext9), ciphertext10), ciphertext11)
a = []
a.append(strxor(ciphertext1, ciphertext11))
a.append(strxor(ciphertext2, ciphertext11))
a.append(strxor(ciphertext3, ciphertext11))
a.append(strxor(ciphertext4, ciphertext11))
a.append(strxor(ciphertext5, ciphertext11))
a.append(strxor(ciphertext6, ciphertext11))
a.append(strxor(ciphertext7, ciphertext11))
a.append(strxor(ciphertext8, ciphertext11))
a.append(strxor(ciphertext9, ciphertext11))
a.append(strxor(ciphertext10, ciphertext11))

for i in xrange(0, 83):
    for x in xrange(32,127):
        for y in xrange(0,10):
            z = strxor(a[y][i], chr(x))[0]
            if ord(z) == 32:
                continue
            if ord(z) < 65:
                break
            # if ord(z) > 90 and ord(z) < 97:
            #     break
            if ord(z) > 122:
                break
            if y == 9:
